    ...
    _handleCheckout(BuildContext context) async {
      ...
      try {
        ...
        if (response.verify == true) {
          App.verifyPayment(Subscription.reference);
                      ...
                      children: <Widget>[
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                child: RaisedButton(
                                  ...
                                  onPressed: () => setState(() => _selectedPlan = Subscription.plans[0]['plan_id']),
                                  color: _selectedPlan == Subscription.plans[0]['plan_id'] ? Color.fromRGBO(107, 43, 20, 1.0) : Colors.white,
                                  textColor: _selectedPlan == Subscription.plans[0]['plan_id'] ? Colors.white : Color.fromRGBO(107, 43, 20, 1.0),
                                  shape: RoundedRectangleBorder(
                              ...
                              Container(
                                ...
                                child: RaisedButton(
                                  padding: EdgeInsets.symmetric(vertical: 20, horizontal: 30),
                                  onPressed: () => setState(() => _selectedPlan = Subscription.plans[1]['plan_id']),
                                  color: _selectedPlan == Subscription.plans[1]['plan_id'] ? Color.fromRGBO(107, 43, 20, 1.0) : Colors.white,
                                  textColor: _selectedPlan == Subscription.plans[1]['plan_id'] ? Colors.white : Color.fromRGBO(107, 43, 20, 1.0),
                                  shape: RoundedRectangleBorder(
                                    borderRadius: new BorderRadius.circular(20.0),
                                    side: BorderSide( color: Color.fromRGBO(107, 43, 20, 1.0), width: 2.0 )
                                  ),
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                child: RaisedButton(
                                  padding: EdgeInsets.symmetric(vertical: 20, horizontal: 30),
                                  onPressed: () => setState(() => _selectedPlan = Subscription.plans[2]['plan_id']),
                                  color: _selectedPlan == Subscription.plans[2]['plan_id'] ? Color.fromRGBO(107, 43, 20, 1.0) : Colors.white,
                                  textColor: _selectedPlan == Subscription.plans[2]['plan_id'] ? Colors.white : Color.fromRGBO(107, 43, 20, 1.0),
                                  shape: RoundedRectangleBorder(
                                    borderRadius: new BorderRadius.circular(20.0),
                                    side: BorderSide( color: Color.fromRGBO(107, 43, 20, 1.0), width: 2.0 )
                                  ),
                              ...
                              Container(
                                ...
                                child: RaisedButton(
                                  padding: EdgeInsets.symmetric(vertical: 20, horizontal: 30),
                                  onPressed: () => setState(() => _selectedPlan = Subscription.plans[3]['plan_id'],),
                                  color: _selectedPlan == Subscription.plans[3]['plan_id'] ? Color.fromRGBO(107, 43, 20, 1.0) : Colors.white,
                                  textColor: _selectedPlan == Subscription.plans[3]['plan_id'] ? Colors.white : Color.fromRGBO(107, 43, 20, 1.0),
                                  shape: RoundedRectangleBorder(
                                    borderRadius: new BorderRadius.circular(20.0),
                                    side: BorderSide( color: Color.fromRGBO(107, 43, 20, 1.0), width: 2.0 )
                                  ),
                        ...
                        Container(
                          ...
                          child: RaisedButton(
                            ...
                            onPressed: _selectedPlan == "" ? null : () async {
                              bool resp = await App.initiatePayment(_scaffoldKey, _selectedPlan);
                              if (resp == true) {
                                _handleCheckout(context);
                              } else {
                                Common.showInfo(_scaffoldKey, 'Please select a plan');
                              }
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                  ...
                                  child: Text("Continue Payment",style: TextStyle( fontSize: 20.0)),
                                ),
