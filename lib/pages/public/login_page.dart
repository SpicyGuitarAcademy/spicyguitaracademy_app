              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: (){ Navigator.popAndPushNamed(context, "/welcome_page");},
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: SizedBox(
                        ...
                        child: RaisedButton(
                          onPressed: () async {
                            var resp = await App.login(_scaffoldKey,_email.text,_pass.text);
                            // App.showMessage(_scaffoldKey, resp.toString());
                            if (resp == true) {
                          ...
                          child: Text("Login",style: TextStyle( fontSize: 20.0, fontStyle: FontStyle.normal))
                        ),
                      ),
                    ),
